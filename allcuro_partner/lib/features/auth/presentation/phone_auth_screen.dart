...
/// Two-step sign-in: enter a phone number, then verify the OTP sent to it.
/// Both steps live on this one screen/route — `PhoneAuthViewModel` tracks
/// which step is active and animates between them. Shares the dark
/// `gradientPrimary` treatment used by `WelcomeScreen` and `RoleSelectScreen`
/// so the whole pre-auth flow reads as one consistent brand moment.
class PhoneAuthScreen extends ConsumerStatefulWidget {
  final VoidCallback onBack;

  const PhoneAuthScreen({super.key, required this.onBack});
      ...
      children: [
        ...
        RichText(
          text: TextSpan(
            ...
            children: [
              TextSpan(text: "We've sent a code to +91 ${widget.phone}. "),
              TextSpan(
                text: 'Edit',
        ...
        const Spacer(),
        Text(
          'Demo mode — use ${AuthService.demoOtp} as the code.',
